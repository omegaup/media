	...
	<div class="full-column">
		...
		<div class="center-column">
			...
			<ul id="menu">
				...
				<li><a href="/acerca-de/"><span>description here</span><br />link 1</a></li>
				<li><a href="/nosotros/"><span>description here</span><br />link 2</a></li>
...
<div class="center-column">
	...
	<div id="header">
		...
		-->
        <a href="http://blog.omegaup.com/"><img src="<?php echo get_template_directory_uri(); ?>/images/blog-logo.png" width="700" height="144" alt="" /></a>
